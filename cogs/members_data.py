...
class MembersData(commands.Cog):
    ...
    @app_commands.command(name="about_update",
                          description="Add/Update information about you. [Private] fields are private by default for first input. You can change your privacy with '/about_privacy' command")
